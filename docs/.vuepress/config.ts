/**
 * 提示：如您想使用JS版本的配置文件可参考：http://caibaojian.com/vuepress/config/
 */
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: 'xugaoyi', // 必需
      link: 'https://github.com/zzxm', // 可选的
    },
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: '0693d247a5a61cd39ed6',
          clientSecret: '1ce2efdeb4f5bf58ebf317280f09d914e4db7e80',
          repo: 'zzxm.github.io', // GitHub 仓库
          owner: 'ZZXM', // GitHub仓库所有者
          admin: ['ZZXM'], // 对仓库有写权限的人
